...
public class ClasspathUtil {
    ...
    public static EclipseProjectType getProjectType(String projectPath) {
        File projectFile = new File(projectPath + File.separator +  ".project");
        ...
        try {
            ...
            if (natures != null) {
                for(Element nature : natures.getChildren()) {
                    ...
                    if (natureKind.contains("com.android.ide.eclipse.adt.AndroidNature"))
                        return EclipseProjectType.ANDROID;
                    else if (natureKind.contains("com.google.gwt.eclipse.core.gwtNature"))
